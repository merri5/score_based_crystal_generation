...
class VPSDE(SDE):
  def __init__(self, beta_min=0.1, beta_max=20, N=1000, continuous = True):
...
class VESDE(SDE):
  def __init__(self, sigma_min=0.01, sigma_max=50, N=1000, continuous = True):
